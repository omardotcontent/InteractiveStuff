...
public final class ScriptInterpreter {
    ...
    private static final NativeFunction debugTextFunction = new DebugText();
    ...
    public static ItemModel itemUpdate(final ItemStack itemStack) {
        ...
        return item.modified ? item : null;
    }
